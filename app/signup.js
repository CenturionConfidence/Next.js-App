...
export default function Home() {
  return (
    ...
    <h1 className="text-white font-bold w-full text-center">Sign in to your account</h1>
    <form class="flex flex-col space-y-3 pt-10 m-auto w-full md:w-1/5">
      ...
      <label for="name" class="text-sm font-medium">Last Name</label>
      <input type="text" id="name" name="name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 rounded-md w-50 px-3 py-2 border border-gray-300" required />
      ...
      <p className="text-white text-center font-10 pt-7">Not a member? <a href="./signup.js" className="text-indigo-500 hover:text-indigo-700">sign up</a></p>
    </form>
    </div>
